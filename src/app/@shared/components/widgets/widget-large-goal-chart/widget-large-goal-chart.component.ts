...
import { defaultChartOptions } from '@core/utils/default-chart-options';
import { createDateArray } from '@core/utils/create-date-array';

@Component({
  selector: 'app-widget-large-goal-chart',
